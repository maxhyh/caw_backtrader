...
class CryptoCompareAPI():
    ...
    def getTopCap(self, param={'tsym': 'USD', 'limit': 100}):
        suburl = "/top/mktcapfull?limit={}&tsym={}".format(param['limit'], param['tsym'])
        data = self._safeRequest(self.url + suburl)
        ...
        vol_from_24h = [i['RAW'][param['tsym']]['VOLUME24HOURFROM'] for i in data]
...
DATA_DIR = '/Users/yihuihuang/Desktop/Crypto/caw_backtrader/data'

df = cc_api.getCandle('BTC', 'USDT', '1h', start_time="2020-01-01",
                      end_time="2020-04-01", e='binance')
df = cc2bt(df)
